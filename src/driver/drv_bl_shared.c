...
int http_fn_api_dash(http_request_t *request) {
    ...
    if (CFG_HasFlag(OBK_FLAG_POWER_ALLOW_NEGATIVE) && NTP_IsTimeSynced()) {
        ...
        poststr(request, "<polygon fill='url(#splitFade)' points='8,170 ");
        for (int i = 31; i >= 0; i--) {
...
int http_fn_custom_dash(http_request_t *request) {
    ...
    if (CFG_HasFlag(OBK_FLAG_POWER_ALLOW_NEGATIVE)) {
        poststr(request, 
            ...
            "<div class='graph-col'>"
            "<div style='position:absolute; top:15px; left:60px; font-size:12px; color:#f44336; text-transform:uppercase;'>Import (+)</div>"
            "<div style='position:absolute; bottom:30px; left:60px; font-size:12px; color:#4caf50; text-transform:uppercase;'>Export (-)</div>"
            ...
            "<line x1='50' y1='20' x2='512' y2='20'/>" 
            "<line x1='50' y1='95' x2='512' y2='95'/>" 
            "<line x1='50' y1='245' x2='512' y2='245'/>" 
            "</g>"
            "<line x1='50' y1='170' x2='512' y2='170' stroke='#777' stroke-width='1.5'/>" 
            
            "<g fill='#888' font-size='12' font-family='monospace' text-anchor='end'>"
            "<text x='40' y='25'>+300</text>"
            "<text x='40' y='100'>+150</text>"
            "<text x='40' y='175' fill='#aaa'>0 Wh</text>"
            "<text x='40' y='250'>-150</text>"
            "</g>"
        ...
        poststr(request, "<g stroke='#777' stroke-width='1'><line x1='8' y1='260' x2='504' y2='260'/></g>");
