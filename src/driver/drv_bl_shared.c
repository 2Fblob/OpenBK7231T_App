...
//((((estimated_energy_hour*60)/check_time))
			...
			// ** Dishwasher control **
			if if (-800 <= net_energy * (60 / (60 - check_time))) {
			...
			if if (-500 <= net_energy * (60 / (60 - check_time))) {
			...
			if if (-1000 <= net_energy * (60 / (60 - check_time))){
			...
			if if (-1200 <= net_energy * (60 / (60 - check_time))) {
