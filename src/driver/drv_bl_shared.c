...
void BL09XX_AppendInformationToHTTPIndexPage(http_request_t *request)
{
    ...
    // Charger Tracker moved to the far right
    hprintf255(request, "<div><span>Charger</span><b id='c-v' style='color:#0099FF;'>%d%%</b></div>", dump_load_relay[5]);
    ...
    if (CFG_HasFlag(OBK_FLAG_POWER_ALLOW_NEGATIVE) && NTP_IsTimeSynced())
    {
        ...
        // Command injection channels - Matches Progressive Color Thresholds
        ...
        poststr(request, "setInterval(function(){rsh(['d-va','d-pwr','d-est','d-bal','c-v','d-sens-body','d-clk', 'inv-btn', 'chg-btn', 'chg-30-btn', 'chg-80-btn']);}, 10000);");
